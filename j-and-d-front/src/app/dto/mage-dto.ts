export class MageDto {

    constructor(
        private _id: number = 0,
        private _name: string = "Mage",
        private _baseHp: number = 6,
        private _baseMp: number = 12,
        private _baseMs: number = 5.0,
        private _baseArmor: number = 8,
        private _baseIni: number = 12,
